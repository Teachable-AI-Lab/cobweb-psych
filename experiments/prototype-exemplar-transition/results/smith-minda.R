  ...
  exp_smith_minda <- read_csv("/Users/cmaclellan3/Projects/cobweb-psych/experiments/prototype-exemplar-transition/results/exp_smith-minda_blocks10_nseeds5_epoch5.csv")
