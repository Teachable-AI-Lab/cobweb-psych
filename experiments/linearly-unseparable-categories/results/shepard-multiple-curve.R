...
for (task_type in task_types) {
  ...
  probs_leaf <- df_summary[df_summary['group'] == 2, 'y']
  probs_observed <- df_summary[df_summary['group'] == 3, 'y']
...
#   )
# MAYBE I don't want to main title...
final_plot <- plot_grid(
...
unlist(correlations_leaf)oragn
